...
- **Kubernetes configuration** (`k8s/`):
  - Helm charts for API deployment (`cv-api/`)
  - Monitoring chart and automation scripts (`setup.sh`, `teardown.sh`)
  - Kubernetes deployment documentation ([k8s/docs/kubernetes.md](k8s/docs/kubernetes.md))
  - Ready-to-use configuration for Minikube and cloud environments
...
- Modular workflow architecture with reusable components
